...
\label{sec:empirical-study-RQ-virtual-time-constrained}
\input{sections/empirical-study-RQ-time-constrained}

% GMK NOTE: These figures will be progressively phased out after the new graphs are added into the paper
