...
Mutation analysis is a technique that has been successfully applied to integrity constraint testing, seeding database schema faults of both omission and commission. Yet, as with traditional mutation analysis for program testing, it is costly to perform. 
