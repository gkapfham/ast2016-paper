...
\inlineheading{Related Work} Although this paper is the first to present the idea of virtual mutation, there is a substantial amount of work focused on improving the efficiency of mutation analysis; due to space constraints we briefly survey some of the most related work. For instance, Just \etal~showed how a compiler-integrated method can make mutation testing faster~\cite{Just2011}. Also, Tuya \etal~applied selective mutation to the mutation testing of SQL \SELECT statements.
