...
% Floats
\newcommand{\Definition}[1]{Definition~\ref{def:#1}\xspace}
\newcommand{\DefinitionWithPage}[1]{\Definition{#1} (page \pageref{def:#1})}
\newcommand{\Subfigure}[2]{Figure~\ref{fig:#1}{#2}\xspace}
\newcommand{\Figure}[1]{Figure~\ref{fig:#1}\xspace}
\newcommand{\Figures}[2]{Figures~\ref{fig:#1} and~\ref{fig:#2}\xspace}
\newcommand{\Section}[1]{Section~\ref{sec:#1}\xspace}
\newcommand{\Table}[1]{Table~\ref{tab:#1}\xspace}
\newcommand{\Subtable}[2]{Table~\ref{tab:#1}{#2}\xspace}
\newcommand{\Tables}[2]{Tables~\ref{tab:#1} and~\ref{tab:#2}\xspace}

%% To help ensure consistent float scaling
\def \algorithmfigurescalefactor {0.85}
