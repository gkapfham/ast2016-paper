...
\begin{abstract}
	\begin{itemize}
		...
		\item Virtual analysis exploits an existing model of database behaviour, used elsewhere for data generation, to reduce this \emph{(to/by substantial figure here)}.
