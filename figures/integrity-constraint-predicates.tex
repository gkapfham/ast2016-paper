...
\caption{\label{fig:integrity-constraint-functions} Integrity constraint predicates functions.}

  {\small \justifying{\noindent This figure gives two functions for obtaining \PK integrity constraint predicates. The
  first function is a general definition, the secondary function applies to the specific behavior of the \sqlite DBMS.
  (Excerpted from McMinn \etal~\cite{McMinn2015}.)} \par}
