...
```{r, graphic_bwplot_schema_mutationscore_vm_tcm, mfig.width=5.7, fig.height=3.5, echo=TRUE}
visualise_mutation_score_time_constrained(time_constrained_data_tidy)
```

```{r, graphic_bwplot_schema_mutationscore_vm_tcm_color, mfig.width=5.7, fig.height=3.5, echo=TRUE}
...
```{r, fig.width=5.7, fig.height=3.4, echo=TRUE}
time_constrained_data <- read_time_constrained_mutation_data_subset()
...
```{r, fig.width=3, fig.height=3.25, echo=TRUE}
